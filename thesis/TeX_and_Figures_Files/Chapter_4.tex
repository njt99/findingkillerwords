...
A similar approach was developed independently by Stolfi and Figuereido (see [FS]).\end{problem}
...
%FIXME \vglue8pt {\textit Definition {\textrm \label{GMT 6.4}.
...
i) (CHECKTHIS sentence.  In order to co-ordinate numbering with Section 7, we will break with the convention used previously in this paper and start the
...
To co-ordinate numbering with Section 7 (where we incorporate round-off error into these formulas) we include the following special
cases of Propositions (CHECKTHIS: ref{GMT 6.2} and ref{GMT 6.3}).  Similarly for Propositions (CHECKTHIS: ref{GMT 6.7}, ref{GMT 6.9}, and ref{GMT 6.10}). 
...
machine arithmetic in Chapters (CHECKTHIS: 6 and 7), doubles will be  machine numbers.
...
The branch of the square root of a complex number is determined by the construction of the square root of a complex in Proposition (CHECKTHIS: ref{GMT 7.14}).  In fact, the square root is in the first or fourth quadrant.
