...
Finally, in several places in the programs {\it verify} and {\it corona} we perform a standard operation on a pair of doubles and must take into account round-off error.  This is easy if we use Lemma 7.0.
