...
\demo{Conventions {\textrm FIXME:8.1}}
...
\demo{Conventions {\textrm FIXME:8.3}}
...
\begin{proposition}{FIXME:8.6} If $x$ and $y$ are 
{\textrm AffApproxes,}
...
{\textrm AffApproxes}  with $D > 0$ {\textrm (}\/see below{\mathrm ),} then
...
{\textrm AffApprox}  with $D > 0$ {\textrm (}\/see below{\mathrm ),}
 then $S(x / y) \supseteq S(x) / S(y)${\textrm ,} where
$$x / y \equiv (r\_f.z; r\_f_0.z, r\_f_1.z, r\_f_2.z; r\_{\textrm error})$$
with
 \begin{eqnarray*}
...
\begin{proposition}{FIXME:8.11{\mathrm a}} If $x$ is an {\textrm AffApprox}
and
...
\begin{proposition}{FIXME:8.11{\mathrm b}} If 
