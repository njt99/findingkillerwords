...
\chapter{Conditions and sub-boxes}\label{Ch.ConditionsTree} % =~ GMT \S 5
  
In this section we expand on some topics mentioned briefly in
Chapter \ref{Ch.WordsParams}
...
round-off error; see 
	Chapters \ref{Ch.AffApprox}, \ref{Ch.XComplex}, \ref{Ch.AffWithEPS}.
...
\begin{figure}[ht]\label{GMT fig5.1}
	\centering
