...
Propositions \ref{GMT 1.28}, \ref{GMT 2.8}, \ref{GMT 3.1}, and \ref{GMT 3.2}.
...
$$\exp(r) = |\exp(R)| = |R^{\prime}| = |z_2 + i z_5|  < 1 = \exp(0)$$ and we are outside of $\exp({\mathcal P}).$

\vglue12pt
 {{\textbf The interesting conditions 
\ref{GMT 5.2}
}}.
\vglue6pt
...
Lemma \ref{GMT 1.25a}) can be used.
...
Lemma \ref{GMT 1.25b}) can be used. Note that in {\textit verify} the function which computes the quantity
...
\ref{GMT 5.3}.
\vglue6pt
 {\textit Construction} \ref{GMT 5.3}: 
...
Figure \ref{GMT 5.1}.
 ...
 %FIXME \centerline{\BoxedEPSF{fig5.1.eps scaled 1250}}

 \begin{quote}{
 Figure \label{GMT 5.1}
...
it minus the omissions which it prints out, it finishes \hbox{\texttt main} by printing out a right bracket into \hbox{\texttt output000000}. 
