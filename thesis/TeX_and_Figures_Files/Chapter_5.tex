...
%FIXME \demo{Conventions and standards {\textrm FIXME:7.4}}
...
(CHECKTHIS:  As in Section 6, we now break with the usual numbering convention.  Note that the above comments provide a proof of the
...
\begin{formula} \label{GMT formula7.0} (${\textrm absUB}(X)$)
	%FIXME {Formula {\textrm FIXME:7.0 (${\textrm absUB}(X)$)}}
